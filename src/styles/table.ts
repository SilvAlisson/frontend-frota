export const TableStyles = {
  ...
  th: "px-5 py-4 text-[10px] font-black text-text-muted uppercase tracking-[0.15em] bg-surface-hover/40 border-b border-border/60 whitespace-nowrap first:pl-6 last:pr-6",
  ...
  // ðŸ’Ž O Toque de Elite: Classe para dados estruturados (Placas, Valores, Datas)
