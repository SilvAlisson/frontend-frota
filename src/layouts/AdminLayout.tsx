  ...
  return (
    <div className="flex h-[100dvh] bg-background w-full overflow-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full relative">
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden bg-background scrollbar-thin scroll-smooth relative flex flex-col min-w-0">
            ...
            <AnimatePresence mode="wait">
              <motion.div 
                ...
                className={`flex-1 w-full min-w-0 max-w-[1600px] mx-auto pb-16 lg:pb-8 ${
