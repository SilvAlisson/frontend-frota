         ...
         <form onSubmit={handleConfirmarReparo} className="space-y-6 pt-2">
            ...
            <div className="bg-success/10 border border-success/20 p-4 rounded-xl text-success-700 flex flex-col">
              ...
              <p className="text-sm font-medium leading-relaxed opacity-90">
                Você atesta estar confirmando que o incidente estrutural envolvendo o veículo <strong className="font-black font-mono tracking-tight text-success uppercase">{defeitoResolvendo?.veiculo.placa}</strong> foi inteiramente restabelecido.
              </p>
            </div>
