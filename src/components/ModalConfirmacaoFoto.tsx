...
const fileInputContainer = "relative border-2 border-dashed border-border rounded-2xl p-4 hover:bg-background transition-all cursor-pointer group hover:border-primary flex flex-col items-center justify-center min-h-[250px] overflow-hidden bg-gray-50/50";
...
// Reduz drasticamente o tamanho da imagem antes do upload
...
export function ModalConfirmacaoFoto({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]"
        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-bold text-gray-700 mb-1 flex items-center justify-between">
              <span>Foto do Comprovante <span className="text-red-500">*</span></span>
              {previewUrl && !loading && (
                <span className="text-xs text-primary font-medium cursor-pointer">Trocar foto</span>
              )}
            </label>
            ...
            <div className={`${fileInputContainer} ${previewUrl ? 'border-primary border-solid p-0 bg-black/5' : ''}`}>
              ...
              {processandoFoto ? (
                ...
                <div className="text-center p-4">
                  <div className="w-16 h-16 mx-auto bg-primary/10 text-primary rounded-full flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                  ...
                  <p className="text-xs text-gray-500 mt-1 max-w-[200px] mx-auto">
                    Certifique-se que o KM e o painel estejam visíveis.
                  </p>
                </div>
              )}
            </div>
