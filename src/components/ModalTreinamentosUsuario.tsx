...
export function ModalTreinamentosUsuario({ usuario, onClose }: ModalProps) {
    ...
    // Carregar treinamentos ao abrir
        ...
        reader.onload = async (evt) => {
            try {
                ...
                const treinamentosFormatados = data.map((row: any) => {
                    // Tenta pegar colunas com nomes variados (Nome, Curso, Treinamento...)
                ...
                if (treinamentosFormatados.length === 0) {
                    alert("Nenhum dado válido encontrado. Verifique se as colunas 'Nome' e 'Data' existem.");
                    setImportando(false);
                    return;
                }

                // Envia lote para o Backend
                ...
                <div className="w-full md:w-1/3 bg-gray-50 p-6 border-r border-gray-100 overflow-y-auto">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-gray-50 px-2 text-gray-500 font-bold">ou importar</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-400 mt-2 text-center leading-tight">
                            Colunas necessárias: <strong>Nome</strong>, <strong>Data</strong>. <br />
                            Opcionais: Vencimento, Obs.
                        </p>
                    </div>
                </div>

                {/* Lado Direito: Lista de Treinamentos */}
