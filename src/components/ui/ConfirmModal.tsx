...
export function ConfirmModal({
    ...
    return (
        ...
        >
            ...
            <div className="relative bg-surface rounded-2xl shadow-2xl shadow-black/60 border border-white/10 w-full max-w-sm overflow-hidden p-6 sm:p-8 transform transition-all animate-in zoom-in-95 slide-in-from-bottom-2 duration-300">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-8">
                    ...
                    <Button
                        ...
                        className="flex-1 w-full"
                        onClick={onConfirm}
                        isLoading={isLoading} // ðŸ”¥ A mágica do Loading entra aqui!
                    >
                        {confirmLabel}
                    </Button>
                </div>
