...
const badgeVariants = cva(
  "inline-flex items-center justify-center px-2.5 py-0.5 text-[10px] uppercase tracking-wider whitespace-nowrap rounded-md border shadow-none text-data",
  {
    variants: {
      variant: {
        default: "bg-primary/20 text-primary border-primary/30 hover:bg-primary/30 hover:border-primary/50 transition-colors",
