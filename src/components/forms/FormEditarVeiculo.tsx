...
// --- CONFIGURAÇÃO: Tipos Sincronizados com o Cadastro ---
...
export function FormEditarVeiculo({ veiculoId, onSuccess, onCancelar }: FormEditarVeiculoProps) {
  ...
  useEffect(() => {
    ...
    const fetchVeiculo = async () => {
      ...
      try {
        ...
        reset({
          placa: veiculo.placa,
          marca: veiculo.marca || '', // Carrega a marca do banco
  ...
  const onSubmit = async (data: VeiculoFormValues) => {
    ...
    try {
      // Correção: Rota corrigida de /veiculo (singular) para /veiculos (plural)
