                    ...
                    <header className="sticky top-0 z-40 -mx-4 sm:-mx-8 px-4 sm:px-8 py-3 backdrop-blur-xl bg-background/60 border-b border-border/40 safe-top">
                        <div className="max-w-7xl mx-auto flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2">
                                <button onClick={() => setModalQrCodeOpen(true)} className="w-10 h-10 rounded-xl bg-surface/50 border border-border/40 hover:bg-surface flex items-center justify-center text-primary transition-all shadow-sm" title="Meu QR Code">
                                    <QrCode className="w-4 h-4" />
                                </button>
                                <button onClick={toggleTheme} className="w-10 h-10 rounded-xl bg-surface/50 border border-border/40 hover:bg-surface flex items-center justify-center text-text-muted transition-all">
                                    {theme === 'light' ? <Moon className="w-4 h-4" /> : <Sun className="w-4 h-4" />}
                                </button>
                                <button onClick={logout} className="w-10 h-10 rounded-xl bg-error/5 border border-error/10 hover:bg-error/20 flex items-center justify-center text-error transition-all hover:rotate-12">
                           ...
                           <section className="lg:col-span-6 flex flex-col gap-6 animate-in zoom-in-95 duration-700 delay-100">
                               ...
                               <div className="flex-1 glass-premium rounded-[2.5rem] p-6 sm:p-8 border border-border/20 shadow-lg flex flex-col">
                                  <div className="flex justify-between items-center mb-6">
                                     ...
                                     <button onClick={() => setView('MONITORAMENTO')} className="text-[10px] font-black uppercase text-primary tracking-widest hover:underline bg-primary/10 px-4 py-2 rounded-xl">
                                        Monitor Completo
                                     </button>
                                  </div>
        ...
        <div className="space-y-6 animate-in slide-in-from-right-8 duration-500 pb-20 min-h-screen bg-background -mx-4 sm:-mx-8 px-4 sm:px-8">
            <div className="flex items-center gap-4 py-6 sticky top-0 z-40 -mx-4 px-4 sm:-mx-8 sm:px-8 backdrop-blur-xl bg-background/80 border-b border-border/40">
                <button 
                  ...
                  className="p-3 rounded-2xl bg-surface hover:bg-surface-hover border border-border/40 hover:border-primary/30 text-text-muted hover:text-primary transition-all active:scale-95 shadow-sm"
                >
