      ...
      <ConfirmModal
        ...
        description={
          <div className="space-y-4">
            <p className="text-sm font-medium text-text-secondary">Você está prestes a forçar o encerramento da jornada sem a validação do operador no telemóvel.</p>
            
            {/* NOSSO CALLOUT SUBSTITUINDO A DIV MANUAL */}
            <Callout variant="warning" title="Encerramento Administrativo" icon={AlertCircle}>
              O KM Final será registado automaticamente como <strong className="font-mono">{jornadaParaEncerrar?.kmInicio} KM</strong> (mesmo valor do odómetro inicial). Utilize esta função apenas para limpezas de sistema ou esquecimentos.
            </Callout>
          </div>
        }
