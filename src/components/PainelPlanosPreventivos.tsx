...
import { AlertTriangle, CheckCircle, Clock, Wrench, ShieldAlert, BarChart2, Plus, Trash2 } from 'lucide-react';
...
export function PainelPlanosPreventivos() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal isOpen={isCriandoPlano} onClose={() => setIsCriandoPlano(false)} title="Novo Plano de Manutenção">
        <FormPlanoManutencao
          onSuccess={() => {
